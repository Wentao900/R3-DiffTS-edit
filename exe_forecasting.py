...
parser.add_argument('--cfg_rescale', type=float, default=0.0, help='guidance rescale factor in [0, 1]; 0 disables CFG rescale')
parser.add_argument('--cfg_delta_clamp_ratio', type=float, default=0.0, help='max guidance increment norm ratio relative to conditional prediction norm; 0 disables clamping')
...
config["diffusion"]["cfg_rescale"] = args.cfg_rescale
config["diffusion"]["cfg_delta_clamp_ratio"] = args.cfg_delta_clamp_ratio
